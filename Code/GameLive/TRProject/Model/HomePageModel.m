...
+(NSDictionary<NSString *,id> *)modelContainerPropertyGenericClass{
    return @{@"list":[List class],@"mobileBeauty":[ReData class],@"mobileDota2":[ReData class],@"mobileHeartstone":[ReData class],@"mobileIndex":[ReData class],@"mobileLol":[ReData class],@"mobileRecommendation":[ReData class],@"mobileStar":[ReData class],@"mobileTvgame":[ReData class],@"moblieBlizzard":[ReData class],@"moblieDnf":[ReData class],@"moblieMinecraft":[ReData class],@"moblieSport":[ReData class],@"moblieWebgame":[ReData class],@"appOwerWatch":[ReData class],@"appClassification":[ReData class]};
}
