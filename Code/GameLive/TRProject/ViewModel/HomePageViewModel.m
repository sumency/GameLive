...
//                self.dataList = nil;
            ...
            NSArray *name = @[@"mobileIndex",@"mobileRecommendation",@"mobileLol",@"mobileBeauty",@"mobileHeartstone",@"mobileHuWai",@"appOwerWatch",@"mobileDota2",@"mobileTvgame",@"moblieBlizzard",@"moblieSport",@"moblieWebgame",@"moblieDnf",@"moblieMinecraft"];
